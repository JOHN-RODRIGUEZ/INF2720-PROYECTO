                ...
                <div class="card card-primary card-outline">
                    <div class="card-body box-profile">
                        <div class="text-center">
                            <img class="profile-user-img img-fluid img-circle" src="view/dist/images/user.png" alt="User profile picture">
                        </div>
                    ...
                    <div class="card-body">
                            ...
                            <div class="post">
                                <div class="user-block">
                                    <img class="img-circle img-bordered-sm" src="view/dist/images/user.png" alt="user image">
                                    <span class="username">
                                        <a href="respuesta/"></a>
                                    </span>
